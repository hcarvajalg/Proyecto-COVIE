...
var covie = window.covie || {};

// Set the operating environment
covie.environment = {
        wwwHome                                 : "http://www.vudu.com/",
        myHome                                  : "https://my.vudu.com/",
        supportHome                             : "http://support.vudu.com/",
        imagesHome                              : (window.location.protocol.indexOf("https") == -1 && window.location.protocol.indexOf("HTTPS") == -1) ? "http://images2.vudu.com/" : "https://images.vudu.com/",
...
covie.configs = {
        ...
        mediaFormat                           	: window._covieAndroidApp? "flash" : "dash",
        // Facebook
        ...
        // Chromecast
        enableMediaMessagingProtocol            : false,
        ancinusPlayer                           : true,
...
covie.urls = {
        ...
        accountCreatePage                       : covie.environment.myHome + (covie.isMobliePage ? "mobileAccountSetup.html" : (window._vuduAndroidApp ? "AndroidAccountCreate.html" : "AccountSetup.html")),
        accountSetupPage                        : covie.environment.myHome + (covie.isMobliePage ? "mobileAccountSetup.html" : (window._vuduAndroidApp ? "AndroidAccountCreate.html" : "AccountSetup.html")),
        androidFaqUrl                           : covie.environment.wwwHome + "android_faq.html",	
        avodUrl									: covie.environment.wwwHome + "movies/#new/movies_on_us",
		avodFaqUrl						        : "http://vudu.custhelp.com/app/answers/detail/a_id/394",
        blankImage                              : "/resources/misc/1x1px_blank.png",
        contactUsPage                           : covie.environment.supportHome + "?supportPage=ask&skippedLogin=true",
        ...
        documentationPage                       : covie.environment.wwwHome + "vudu_documentation.html",
        externalPageRedirect                    : covie.environment.wwwHome + "resources/html/externalPageRedirect.html",
        extrasPlusPoster                        : "/resources/extrasplus/extrasPlusPoster.png",
        facebookJsSdk                           : "//connect.facebook.net/en_US/sdk.js",
        freeMoviesPromoFAQPage                  : covie.environment.wwwHome + "account_promotion.html",
        giftUnWrapWidgetPage                    : covie.environment.wwwHome + "gift_wrap_widget/main/unwrap.html",
        ...
        walmartGiftCardImage                    : VUDU.environment.myHome + "images/" + (VUDU.isMobliePage ? "walmart-gift-card-back-mobile.png" :"walmart-gift-card-back.png"),
...
var vuduDefault = {
  ...
  success: ["<p>Congratulations!  You now own a digital copy of ${MOVIE}.</p>"
    ...
    + "<p>To watch now on your internet connected PC or Mac, <a href=\"http://www.vudu.com/movies/\" target=\"_blank\">click here</a>, "
    ...
    + "<ul>"
    + "<li><span style=\"font-weight:bold\">Blu-ray player or TV:</span> <a href=\"http://www.vudu.com/devices.html\" target=\"_blank\">click here</a> for a list of devices.</li>"
    + "<li><span style=\"font-weight:bold\">PlayStation&trade;3 System:</span> <a href=\"http://www.vudu.com/setup_ps3.html\" target=\"_blank\">click here</a> to get VUDU on your PS3.</li>"
    + "</ul>"
  ],
  ...
  successFooter: ["<p>You can watch movies on VUDU in one of these ways:</p>"
    + "<ul>"
    +   "<li>On a PlayStation&reg;3 System.  <a href=\"http://www.vudu.com/setup_ps3.html\" target=\"_blank\">Click here</a> to get VUDU on your PS3.</li>"
    +   "<li>On a Xbox 360&reg; <a href=\"http://www.vudu.com/setup_xbox.html\" target=\"_blank\">Click here</a> to get VUDU on your Xbox 360&reg;.</li>"
    +   "<li>On a VUDU-enabled Blu-ray&trade; player or TV.  <a href=\"http://www.vudu.com/devices.html\" target=\"_blank\">Click here</a> for a complete list of devices.</li>"
    +   "<li>On your PC or Mac.  <a href=\"http://www.vudu.com/movies/\" target=\"_blank\">Click here</a> to continue.</li>"
    + "</ul>"
  ]
};
...
var accountConfig = {
  ...
  api                      : "http://apicache.vudu.com/api2/",
  secureApi                : "https://api.vudu.com/api2/",
  useXHR                   : "true",

  mediaImagesUrl           : (window.location.protocol.indexOf("https") == -1 && window.location.protocol.indexOf("HTTPS") == -1) ? "http://images2.vudu.com/" : "https://images.vudu.com/",
  secureMediaImagesUrl     : "https://images.vudu.com/",
  ...
  devices                  : "http://www.vudu.com/devices/Devices.html",
  movies                   : "http://www.vudu.com/movies/",
  myMovies                 : "http://www.vudu.com/movies/#my_vudu/my_movies",
  passwordReset            : "https://myvudu.vudu.com/PasswordReset.html",
  tosUrl                   : "http://www.vudu.com/termsofservice.html",
  privacyPolicyUrl         : "http://www.vudu.com/privacypolicy.html",
  getVudu                  : "http://www.vudu.com/devices.html",
  selectECopyURL           : "http://www.vudu.com/ecopy.html",
  ...
  zendeskUrl        		: null,
  supportUrl                : "http://www.vudu.com/support.html",
  promoAnswerUrl            : "http://www.vudu.com/faq.html#promo",

  redeeemECopyURL           : "http://www.vudu.com/redeemecopy.html",
  ...
  httpUltraVioletTOSCallBackURL : "http://www.vudu.com/resources/html/ultraVioletTOSCallback.html",
  ...
  uvFAQURL                  : "http://www.vudu.com/support.html?supportPage=answers/list/search/1/kw/ultraviolet/search/1",
  uvShareFAQURL             : "http://www.vudu.com/support.html?supportPage=answers/list/search/1/kw/ultraviolet%20share%20movies",
  ...
  boxeeDownload            : "http://www.vudu.com/product_boxee.html",
  ...
  simplePromotions         : { "promotions" : [
    { name : ["digitalcopy"], /* must be all lower case */
      ...
      body: [ "<p class=\"vudu-label-title\">Redeem Offer: Step 1 of 2</p>"
        ...
        + "or <a href=\"http://www.vudu.com/devices.html\" target=\"_blank\">"
    ...
    { name : ["moviecard"], /* must be all lower case */
      ...
      successFooter: [ "<br/><p class=\"simple-promo-header\">Other great titles also available from VUDU:</p>"
        ...
        + "<td><a href=\"http://www.vudu.com/movies/#!content/184967\"><img src=\"https://images.vudu.com/poster2/184967-m\"/></a></td>"
        + "<td><a href=\"http://www.vudu.com/movies/#!content/185654\"><img src=\"https://images.vudu.com/poster2/185654-m\"/></a></td>"
        + "<td><a href=\"http://www.vudu.com/movies/#!content/181828\"><img src=\"https://images.vudu.com/poster2/181828-m\"/></a></td>"
        + "<td><a href=\"http://www.vudu.com/movies/#!content/181808\"><img src=\"https://images.vudu.com/poster2/181808-m\"/></a></td>"
        + "<td><a href=\"http://www.vudu.com/movies/#!content/178811\"><img src=\"https://images.vudu.com/poster2/178811-m\"/></a></td>"
        + "</tr><tr>"
    ...
    { name : ["netgear"], /* must be all lower case */
      ...
      body: ["<p class=\"vudu-label-title\">Redeem Movie Credit: Step 1 of 2</p>"
        ...
        + "<a href=\"http://www.vudu.com/devices.html\" target=\"_blank\">"
    ...
    { name : ["blackswan"], /* must be all lower case */
        image: ["https://images.vudu.com/poster2/167817-232"],
    ...
    { name : ["lgsmarttv"], /* must be all lower case */
     ...
     { name : ["devilinside"], /* must be all lower case */
         image: ["https://images.vudu.com/poster2/288506-232"],
       ...
       { name : ["jeffwholivesathome"], /* must be all lower case */
           image: ["https://images.vudu.com/poster2/304931-232"],
           lowerImage: ["resources/logo/walmart_logo.png"],
           body: [ "<p class=\"vudu-label-title\">Redeem Offer: Step 1 of 2</p>"
             + "<p>Thank you for your recent purchase. To get your digital "
             + "copy on VUDU, please enter the promotion code you "
...
VUDU.config = {
  ...
  webHomePage              : "http://www.vudu.com",
  ps3page                  : "http://www.vudu.com/setup_ps3.html",
  tosUrl                   : "http://www.vudu.com/termsofservice.html",
  tvBlueRayPage            : "http://www.vudu.com/setup_hdtv.html",
  referAFriendUrl          : "http://www.vudu.com/referafriend.html",
  moviesPageUrl            : "http://www.vudu.com/movies/",
  ...
  playbackSize             : "960px:540px",
  playbackFlashUrl         : "/flash/StrobeMediaPlayback.swf",
  embeddedPlayerBaseUrl    : "http://www.vudu.com/movies/player.html",
  debugPlaybackFlashUrl    : "/flash/StrobeMediaPlaybackDebug.swf",
  playbackInstallUrl       : "/flash/expressInstall.swf",
  downloaderLauncherUrl    : "/flash/DownloaderLauncher.swf",
  myAccountUrl             : "https://my.vudu.com/MyAccount.html",
  myMoviesUrl              : "http://www.vudu.com/movies/#my_vudu/my_movies",
  mypreordersUrl           : "http://www.vudu.com/movies/"+ (window._vuduAndroidApp ? "Movies_Android.html" : "") + "#my_vudu/my_preorder",
  freeMoviesPromoUrl       : "http://www.vudu.com/account_promotion.html",
  dtdPageUrl               : "http://www.vudu.com/disc_to_digital.html",
  homeDtdPageUrl           : "http://www.vudu.com/in_home_disc_to_digital.html",
  redeeemECopyURL          : "http://www.vudu.com/redeemecopy.html",
  devicesPageURL           : "http://www.vudu.com/devices.html",
  ecopyPageURL             : "http://www.vudu.com/ecopy.html",
  playbackFlashNetwork     : "production",
